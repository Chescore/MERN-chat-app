...
const Chatroom = () => {
                ...
                <div key={i} className='flex justify-end p-2'>
                    <div className='grid grid-cols-12'>
                        <div className='col-start-5 col-end-13'>
                            <div className='text-right text-slate-400  text-xs'>You:</div>
                            <div className='bg-gradient-to-tr from-cyan-500 to-blue-700 text-slate-300 px-3 py-2 rounded-xl'>
                                <div>{item.message}</div>
                            </div>
                            <div className='flex justify-end text-slate-400 py-1 text-xs' >
                                {item.timestamp}
                            </div>
                        </div>
                    </div>
                ...
                <div key={i} className='flex justify-start p-2'>
                    <div className='grid grid-cols-12'>
                        <div className='col-start-1 col-end-9'>
                            <div className='text-slate-600  text-xs'>{item.name}:</div>
                            <div className='bg-gradient-to-tr from-purple-800 to-violet-500 text-slate-300 px-3 py-2 rounded-xl'>
                                <div>{item.message}</div>
                            </div>
                            <div className='flex justify-start text-slate-400 py-1 text-xs' >
                                {item.timestamp}
                            </div>
                        </div>
                    </div>
    ...
    return (
        <div className='grid grid-rows-[50px_minmax(0,_0.96fr)] height shadow border w-80 md:w-96'>
            <div className='uppercase text-white bg-blue-800 p-2.5'>
                <div className='flex justify-between'>
                <span>
                    <Link to='/dashboard'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 pt-1 hover:text-slate-300  cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className='bg-cyan-50 border text-sm border-b-blue-800 overflow-y-scroll'>
            ...
            <form className='grid grid-cols-10'>
                <div className='col-span-8 flex bg-white'>
                    <input type='text'
                    className='px-3 bg-white w-full outline-none transition-ease-in-out placeholder:text-slate-400'
                ...
                className='select-none col-span-2 flex justify-center items-center bg-blue-800 hover:bg-blue-700 active:bg-blue-600'>
                    <div className='pr-0 pb-1/2  text-slate-300 uppercase'>
                        Send
                    </div>
                </button>
            </form>
